...
if __name__ == "__main__":
    ...
    flags.DEFINE_integer("export_model_steps", 3000,
...
def get_input_data_tensors(reader,
    ...
    with tf.name_scope("train_input"):
        ...
        validate_files = gfile.Glob('gs://youtube8m-ml-us-east1/2/frame/validate/validate0[0-9]*.tfrecord')
        files = list(set(files) - set(validate_files))
        if not files:
        ...
        return tf.train.shuffle_batch_join(
                ...
                allow_smaller_final_batch=False,     #Shreesh : Changed to False (See https://www.kaggle.com/c/youtube8m-2018/discussion/58969)
                enqueue_many=True)
