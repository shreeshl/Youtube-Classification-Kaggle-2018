...
class CrossEntropyLoss(BaseLoss):
  ...
  def calculate_loss(self, predictions, labels, **unused_params):
    with tf.name_scope("loss_xent"):
      # f = StringIO(file_io.read_file_to_string('gs://dadjaipur_yt8m_train_bucket/gatednetvladLF-128k-1024-80-0002-300iter-norelu-basic-gatedmoe/weights.npy'))
      # weights = np.load(f)
      ...
      # cross_entropy_loss = tf.multiply(cross_entropy_loss, weights)
